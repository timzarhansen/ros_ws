        ...
        for sizePixel_ in sizePixel:
            for N_ in N:
                ...
                with open(bashFileNameHost, "w") as file:
                    file.write("#!/bin/bash\n")
                    file.write("sudo  apt install python3.10-venv -y\n")
                    file.write("cd /home/tim-external/\n")
                    file.write("python3 -m venv myCustomvenv\n")
                    file.write("source /home/tim-external/myCustomvenv/bin/activate\n")
                    file.write("pip install asrl-pyboreas\n")
                    ...
                    file.write(f"python3 boreasTestFileFS2D.py {str(N_)} 1 0.1 {str(sizePixel_)} {str(numberOfSkips_)} {str(sequence_)} /home/tim-external/dataFolder/radar_boreas/")
