            ...
            for level_potential_translation_ in level_potential_translation:
                for N_ in N:
                    ...
                    with open(bashFileNameHost, "w") as file:
                        ...
                        file.write(f"python3 testingSoftOnPredatorData.py configFiles/predatorNothing.yaml {str(N_)} {str(clahe_)} {str(r_min)} {str(r_max)} {str(level_potential_rotation_)} {str(level_potential_translation_)} {str(normalization_factor_)}  ")
                        #
                    ...
                    while 1:
                        try:
                            ...
                            if (total_memory_usage < 50 and len(containers)<10):
