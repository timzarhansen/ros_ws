...
[ -f /home/benchmark/ros_ws/install/setup.bash ] && source /home/benchmark/ros_ws/install/setup.bash
...
export PYTHONPATH="$(compute_pythonpath /opt/ros/jazzy /home/benchmark/ros_ws/install)"
