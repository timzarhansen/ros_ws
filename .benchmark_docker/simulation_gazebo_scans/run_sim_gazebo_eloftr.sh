...
# ============================================================================
# Lidar Simulation 2D Benchmark Runner — eloftr method
# ============================================================================
...
eloftr_N=256
eloftr_RADIUS=15.0
ELOFTR_RATIO_THRESHOLD=0.7
ELOFTR_RANSAC_THRESHOLD=1.0
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --eloftr-ratio-threshold) ELOFTR_RATIO_THRESHOLD="$2"; shift 2 ;;
...
LOG_FILE="${RESULTS_DIR}/run_sim_gazebo_${TIMESTAMP}_eloftr.log"

echo "=============================================="
echo "  Lidar Simulation 2D Benchmark — eloftr"
echo "=============================================="
echo "Started:     $(date)"
...
METHOD_CONFIG="eloftr.ratio_threshold=0.7 eloftr.ransac_threshold=1.0 eloftr.ransac_confidence=0.99"
